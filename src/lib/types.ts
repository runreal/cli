...
import type { ConfigSchema, InternalSchema, RunrealConfigSchema, UserRunrealPreferencesSchema } from './schema.ts'
...
export type XRunrealConfig = z.infer<typeof RunrealConfigSchema>
